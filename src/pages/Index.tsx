...
const Countdown = () => {
  ...
  useEffect(() => {
    const target = new Date("2026-04-20T00:00:00").getTime(); // Fixed wedding date
          ...
          <div className="bg-background/70 backdrop-blur-sm border rounded-lg p-6 md:p-8 shadow-md">
            ...
            <dl className="space-y-4">
              <div>
                ...
                <dd className="text-foreground font-medium">Adeen's Park, Daulatabad, Kesapuri, Maharashtra 431002</dd>
              </div>
              <div>
                <dt className="text-sm uppercase tracking-wide text-muted-foreground">Date & Time</dt>
                <dd className="text-foreground font-medium">20 Apr, After Namaz-e-asar </dd>
              </div>
              <div>
                <dt className="text-sm uppercase tracking-wide text-muted-foreground"></dt>
                <dd className="text-muted-foreground">
                 In shaa Allah,  Nikah will  take place at Adeen's Park, Daulatabad, Kesapuri, Maharashtra 431002
                </dd>
              </div>
...
const Index = () => {
  return (
    <>
      ...
      <h1 className="sr-only">Fayash</h1>
      <Nav />
      <main>
        <section
          id="home"
